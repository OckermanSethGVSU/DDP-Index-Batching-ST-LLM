...
class ST_LLM(nn.Module):
    def __init__(
        ...
        # time slices - ie. take 24 hours and divide it by however your data breaks up time
        if num_nodes == 170 or num_nodes == 307:
            time = 288 # 5 min increments
        elif num_nodes == 250 or num_nodes == 266:
            time = 48 # 30 min increments
        # PEMS Datasets
        elif num_nodes == 207 or num_nodes == 325:
            time = 288 # 30 min increments
